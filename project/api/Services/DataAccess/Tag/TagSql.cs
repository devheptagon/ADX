...
class TagSqlStrings
{
    ...
    public static string SelectByPageSql = SelectSql; //@"SELECT * FROM [Tag] AS T ORDER BY T.title OFFSET(@PAGE-1) * " + Constants.PAGE_SIZE + " ROWS FETCH NEXT " + Constants.PAGE_SIZE + " ROWS ONLY";
